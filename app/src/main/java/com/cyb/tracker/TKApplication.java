...
public class TKApplication extends Application {
    ...
    private EMMessageListener emMessageListener = new EMMessageListener() {
        ...
        public void onMessageReceived(List<EMMessage> messages) {
            Logger.d("cybClient", "onMessageReceived " + messages);
        }

        @Override
        public void onCmdMessageReceived(List<EMMessage> messages) {
            Logger.d("cybClient", "onCmdMessageReceived " + messages);
        }

        @Override
        public void onMessageRead(List<EMMessage> messages) {
            Logger.d("cybClient", "onMessageRead " + messages);
        }

        @Override
        public void onMessageDelivered(List<EMMessage> messages) {
            Logger.d("cybClient", "onMessageDelivered " + messages);
        }
